...
const CAPEX_DATA = {
  ...
  tracks: [
    ...
    },
    {
      ...
      subsectors: [
        { id: "eth", label: "Ethernet Switching", badge: null, tickers: ["ANET","CSCO","JNPR"],
        ...
        { id: "cable", label: "Cables & Connectors", badge: null, tickers: ["FN","CALIX"],
    ...
    },
    {
      ...
      subsectors: [
        ...
        { id: "neocloud", label: "GPU Cloud Operators", badge: "RAPID GROWTH", badgeColor: "#34d399",
          tickers: ["CONE","IREN","CORZ","APLD"],
          materials: ["Power Infrastructure","Cooling Systems","High-density Racks"] },
        { id: "servers", label: "AI Server Infrastructure", badge: null, tickers: ["SMCI","VRT","VERTIV"],
    ...
    },
    {
      ...
      subsectors: [
        { id: "grid", label: "Power Generation & Utilities", badge: "GRID BOTTLENECK", badgeColor: "#ef4444",
          tickers: ["VST","NEE"], materials: ["Copper Grid","Silicon Steel Transformers","Lithium Storage"] },
        { id: "ups", label: "Power Management & UPS", badge: null, tickers: ["ETN","VERTIV"],
