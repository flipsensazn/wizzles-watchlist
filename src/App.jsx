    ...
    },
    {
      ...
      subsectors: [
        { id: "engine", label: "Optical Engine & Transceiver L1", badge: null,
          tickers: ["LITE","COHR","AAOI","ALMU","MTSI","FN"],
    ...
    },
    {
      ...
      subsectors: [
        { id: "grid", label: "Power Generation & Utilities", badge: "GRID BOTTLENECK", badgeColor: "#ef4444",
          tickers: ["VST","NEE","BE","LEU","OKLO"], materials: ["Copper Grid","Silicon Steel Transformers","Lithium Storage"] },
    ...
    },
    {
      ...
      subsectors: [
        ...
        { id: "neuro", label: "Neuromorphic & Edge AI", badge: "EARLY STAGE", badgeColor: "#c084fc",
          tickers: ["GTLB"], materials: ["Phase-Change Materials","Memristive Oxides","Hafnium Oxide"] },
      ],
    },
  ],
};
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 8, cursor: "default", transition: "border-color .15s",
        position: "relative",
      }}>
        ...
        {!addingTicker ? (
          ...
          <div style={{ display: "flex", gap: 6 }}>
            ...
            <button onClick={handleAdd} style={{
              ...
              color: "#60a5fa", borderRadius: 6, padding: "5px 10px",
...
export default function App() {
  ...
  useEffect(() => {
    try {
      localStorage.setItem("capexData", JSON.stringify(capexData));
    } catch {
  ...
  const refresh = useCallback(async () => {
    setRefreshing(true);
    const newPrices = await fetchLivePrices(getAllTickers(capexData));
      ...
      <div className="grid-bg" style={{
        ...
        <div style={{ maxWidth: 1480, margin: "0 auto", padding: "28px 24px", display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{
              width: "100%", maxWidth: 480, borderRadius: 20, padding: "24px 28px", textAlign: "center",
              ...
              <div style={{ fontSize: 52, fontWeight: 800, color: "#fbbf24", fontFamily: "'Syne',sans-serif", lineHeight: 1, marginBottom: 4 }}>~$600B+</div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, fontSize: 10, color: "#1e293b", borderTop: "1px solid rgba(255,255,255,.04)", paddingTop: 16, flexWrap: "wrap" }}>
            ...
            <span style={{ marginLeft: "auto", color: "#1e293b" }}>Live via Finnhub · auto-refreshes 30s</span>
          </div>
        </div>
      </div>
    </>
